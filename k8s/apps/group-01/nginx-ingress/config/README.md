...
NOTE: There are several versions of nginx-ingress including one by the Kubernetes team. This is the Bitnami version.

### Directory Structure

This application contains 5 files by default:

* **README.md** - This README file.
* **basic-auth-secrets.sops.yaml** \- This file contains the secrets for basic-auth of applications with the `auth: basic-auth` label on their namespace.
* **kustomization.yaml** \- Defines the files to include/exclude.
* **nginx-ingress-patch.yaml** \- This file contains the custom settings you require for the nginx-ingress HelmRelease.
* **secrets.sops.yaml** \- This file contains the secrets for nginx-ingress, default value is Maxmind License Key.

**Please note:** <em>If you are adding or removing files in the config directory you will need to **modify the kustomization.yaml file in this directory** to include or exclude the files you wish to use.</em>

```
├── README.md
├── basic-auth-secrets.sops.yaml
├── kustomization.yaml
...
type: Opaque
###
### Note this value is the same as an htpassword file.
### eg. `htpasswd -nb user password`
###
stringData:
    auth: |
        testuser:$apr1$LXAD.ciL$.x8TV3t0/9q8zUbAq9kSQ.
```
...
data:
  values.yaml: |-
    ...
    ##
    config:
      custom-http-errors: "400,401,402,403,404,405,406,407,408,409,410,411,412,413,414,415,416,417,418,419,420,421,422,423,424,425,426,427,428,429,430,431,444,450,451,494,495,496,497,498,500,501,502,503,504,505,506,507,508,509,510,511,529,530,598,599"
    #  ssl-redirect: "false"
    #  force-ssl-redirect: "false"
      #enable-real-ip: "true"
      #real_ip_header: "X-Forwarded-For"
      #real_ip_header: "CF-Connecting-IP,X-Forwarded-For"
      use-forwarded-headers: "true"
      #proxy-add-original-uri-header: "true"
      #compute-full-forwarded-for: "true"
      #whitelist-source-range: "10.2.0.0/16, 173.245.48.0/20, 103.21.244.0/22, 103.22.200.0/22, 103.31.4.0/22, 141.101.64.0/18, 108.162.192.0/18, 190.93.240.0/20, 188.114.96.0/20, 197.234.240.0/22, 198.41.128.0/17, 162.158.0.0/15, 104.16.0.0/13, 104.24.0.0/14, 172.64.0.0/13, 131.0.72.0/22, 2400:cb00::/32, 2606:4700::/32, 2803:f800::/32, 2405:b500::/32, 2405:8100::/32, 2a06:98c0::/29, 2c0f:f248::/32"
    ...
    ##
    maxmindLicenseKey: "${SECRET_INGRESS_NGINX_MAXMIND_LICENSE_KEY}"
    ###^
    ...
    ##
    #podAnnotations: ingress-${CONFIG_INFRA_CLUSTER}.${CONFIG_INFRA_DOMAIN}/tunnel-id: c99f60f7-364c-4a82-9379-94d2408c47ae
    ###^
    ...
    defaultBackend:
      ...
      ##
      hostAliases: []
      ### Error page backend - https://github.com/tarampampam/error-pages
      ### tarampampam/error-pages template options:
      ###   - ghost
      ###   - l7-light
      ###   - l7-dark
      ###   - shuffle
...
metadata:
    ...
    namespace: nginx-ingress
stringData:
    SECRET_INGRESS_NGINX_MAXMIND_LICENSE_KEY: abcdefghijklmnopqrstuvwxyz01234567890ABC
```
