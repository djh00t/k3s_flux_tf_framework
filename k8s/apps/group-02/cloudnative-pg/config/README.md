...
This directory contains files that are used to configure cloudnative-pg.
...
* **cluster.yaml** - The cluster configuration file for cloudnative-pg.
* **configmap.yaml** - This file contains the configuration for cloudnative-pg.
* **kustomization.yaml** - This file is used by kustomize to build the final YAML files.
* **postgres-secrets.sops.yaml** - This file contains the secrets for cloudnative-pg.
